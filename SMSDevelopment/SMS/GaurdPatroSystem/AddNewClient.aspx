<%@ Page Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddNewClient.aspx.cs" Inherits="GaurdPatroSystem.AddNewClient"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
      ...
      <tr>  
         ...
         class="Label2"  style=" width:167px" BackColor="#FFFFCC" >
        </asp:DropDownList>
          </td> 
       </tr>
       <tr>
       ...
       <tr>
          <td colspan="2">
              <asp:Button ID="btnAdd" runat="server" Text="Add" onclick="btnAdd_Click" Width="80px" style=" margin-left:195px"
               />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
