    ...
    <div class="divContainer">
        ...
        <asp:panel runat="server" ID="Pnl" BackColor="White" 
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtgaurdreq" CssClass="Input" runat="server" Width="146px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td colspan="4">
                    <asp:TextBox ID="txtspecialreq" CssClass="Input" runat="server" Width="146px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtdutygaurd" CssClass="Input" runat="server" Width="146px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txttoDate" CssClass="Input" runat="server" 
                        OnTextChanged="txttoDate_TextChanged" Height="20px" Width="150px"></asp:TextBox>
            ...
            <tr>
                ...
                <td colspan="7" height="55">
                    <asp:TextBox ID="txtEventComment" runat="server" CssClass="Input" Height="74px" 
