<%@ Page Language="C#" MasterPageFile="~/master/SpaMaster.Master" AutoEventWireup="true"
    CodeBehind="Check_Out_Guard.aspx.cs" Inherits="SMS.SMSUsers.Check_Out_Guard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="divHeader">
        <span class="pageTitle">Check Out Security Officer</span></div>
    <div>
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="2">
                <table id="tblEntry" style="display: none; border: none">
                    <tr>
                        <td>
