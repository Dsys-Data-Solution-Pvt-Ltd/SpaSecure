<%@ Page Language="C#" MasterPageFile="~/SMSmaster.Master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="SMS.SMSCommons.Admin" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="divContainer">
        <div class="divHeader"><span class="pageTitle">Admin</span></div> 
                         ...
                         <div>
                             <asp:Panel runat="server">
                                 <table>
                                     ...
                                     <tr>
                                         <td>
                                             <asp:GridView  id="Site_table1" runat="server"
                             ...
                             <asp:Panel runat="server">
                                 <table>
                                     ...
                                     <tr>
                                         ...
                                         <tr>
                                             <td>
                                                 <asp:GridView ID="SiteTable" runat="server"
                                                        allowpaging="true" allowsorting="true"
                                                        autogeneratecolumns="false" cellpadding="5" cellspacing="0" width="100%"
