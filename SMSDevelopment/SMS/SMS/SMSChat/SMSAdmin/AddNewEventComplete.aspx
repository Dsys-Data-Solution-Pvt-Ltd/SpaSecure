<%@ Page Language="C#" MasterPageFile="~/SMSmaster.Master" AutoEventWireup="true" CodeBehind="AddNewEventComplete.aspx.cs" Inherits="SMS.SMSAdmin.AddNewEventComplete" Title="Untitled Page" %>
            ...
            <tr>
                <td>
                    <table id="tblInsertMsg" visible="false" runat="server">
                        <tr>
                            <td>
                                <asp:label id="lblMsg1" cssclass="Labels" runat="server">You have successfully Added a Event Information.</asp:label>
                            </td>
                        </tr>
                    </table>
                    <table id="tblUpdateMsg" visible="false" runat="server">
                        <tr>
                            <td>
                                <asp:label id="lblMsg2" cssclass="Labels" runat="server">You have successfully Updated a Event Information record.</asp:label>
                            </td>
                        </tr>
                    </table>
                    <table id="tblDeleteMsg" visible="false" runat="server">
                        <tr>
                            <td>
                                <asp:label id="lblMsg3" cssclass="Labels" runat="server">You have successfully Deleted a Event Information .</asp:label>
                            </td>
                        </tr>
                    </table>
                    <table>
