<%@ Page Title="" Language="C#" MasterPageFile="~/master/SpaMaster.Master" AutoEventWireup="true" CodeBehind="RosterSummaryReport.aspx.cs" Inherits="SMS.Reports.RosterSummaryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="divHeader">
        <span class="pageTitle">Roster Summary Report</span>
    </div>
    <table width="100%">
        <tr>
            <td>
    ...
    <asp:Panel ID="panelgrid1" runat="server">
        <telerik:RadGrid ID="gvRoster" runat="server" CssClass="RadGrid" GridLines="None"
            ...
            <MasterTableView CommandItemDisplay="Bottom" DataKeyNames="MRID">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn UniqueName="Role" HeaderText="Role" DataField="Role" CurrentFilterFunction="Contains"
                     ...
                     <telerik:GridBoundColumn UniqueName="mn" HeaderText="Month" DataField="mn" CurrentFilterFunction="Contains"
                        AutoPostBackOnFilter="true" ShowFilterIcon="false">
                    </telerik:GridBoundColumn>
                </Columns>
                <NoRecordsTemplate>
