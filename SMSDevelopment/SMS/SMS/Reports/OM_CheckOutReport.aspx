<%@ Page Title="" Language="C#" MasterPageFile="~/master/SpaMaster.Master" AutoEventWireup="true" CodeBehind="OM_CheckOutReport.aspx.cs" Inherits="SMS.SMSUsers.Reports.OM_CheckOutReport" %>
...
<div class="divContainer">
        ...
        <asp:panel runat="server" ID="Pnl" BackColor="White" 
                            style=" margin-left:1.5em; margin-top: 0px;" Font-Bold="True"  Width="750px" Visible="false">
            ...
            <table id="tblSearchbtn" runat="server" visible="false"
             width="750px" style="margin-left:1.4em; margin-bottom:-0.4em;border:1px;border-style:groove; border-color:Black; background-color:Gray">
      ...
      <%--  <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                ...
                <telerik:RadGrid ID="gvItemTable1" runat="server" CssClass="RadGrid" GridLines="None"
                    ...
                    <MasterTableView CommandItemDisplay="Bottom" DataKeyNames="checkout_id">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="checkout_time" DataField="checkout_time"
                                HeaderText="Out Time" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true"
        ...
        <asp:Panel ID="pnlUpdate"  runat="server" BackColor="White"
            ...
            <center>
                   ...
                   <hr  style=" background-color:Black; color:Black; border-color:Black"></hr>
                    ...
                    <tr>
                        <td colspan="4">
                        <center>                            <asp:Label ID="lblIncidentReport" Text="OM Visit Report" CssClass="Labels" runat="server"
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                           : <asp:Label ID="txtInTimeView" CssClass="Reportcolor" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="3">
                           : <asp:Label ID="txtOutTimeView" CssClass="Reportcolor" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <asp:Panel ID="pnlUpdateCurr" runat="server" BackColor="White"
            Height="550px" Width="750px" Style="display: none">
        ...
        <asp:Panel ID="pnlDelete" runat="server" BackColor="White" Height="200px" Width="320px"
            ...
            <asp:Panel ID="panel1" runat="server" Width="750px" Visible="false" style="margin-left:1.3em">
