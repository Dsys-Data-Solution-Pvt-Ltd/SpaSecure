<%@ Page Language="C#" MasterPageFile="~/SMSmaster.Master" AutoEventWireup="true" CodeBehind="AdminSuperOffLeave.aspx.cs" Inherits="SMS.SuperVisor.AdminSuperOffLeave"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="divContainer">
        <div class="divHeader">
            <span class="pageTitle">Verify OFF/Leave Applications</span>
        </div>
        <br />
    ...
    <div>
        <asp:panel  ID="panel1" runat="server">
            ...
            <Columns>  
                        ...
                        <asp:BoundField DataField="LeaveDayCount" HeaderText="Apply Leave Day Count"></asp:BoundField>
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ImageUrl="../Images/Edit.gif" ID="btnEdit" CommandArgument ='<%# DataBinder.Eval(Container, "DataItem.Leave_id") %>' CommandName="EditRow" runat="server"/>
                        </ItemTemplate>
