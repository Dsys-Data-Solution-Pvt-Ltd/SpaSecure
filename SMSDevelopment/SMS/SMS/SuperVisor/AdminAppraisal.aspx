<%@ Page Language="C#" MasterPageFile="~/master/login.Master" AutoEventWireup="true" CodeBehind="AdminAppraisal.aspx.cs" Inherits="SMS.SuperVisor.AdminAppraisal"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div class="divContainer">
  <div class="divHeader">
     <span class="pageTitle">Staff Feedback</span></div>
        ...
        <asp:Button ID="btnSearchPassAdd" Text="Search" runat="server" style=" margin-left:320px; margin-top:.2em"
       ...
       <br />
           <div style=" margin:2em">
            <asp:gridview id="gvPassTable" runat="server" allowpaging="True" allowsorting="True"
                ...
                <Columns>    
                         <asp:BoundField datafield="Date" headertext="Date"><HeaderStyle Width="250px"/></asp:BoundField>       
                         <asp:BoundField datafield="NRICno" headertext="NRIC No."><HeaderStyle Width="250px"/></asp:BoundField>
                         <asp:BoundField datafield="Name" headertext="Name"></asp:BoundField>                     
                     <asp:TemplateField HeaderText="View" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:ImageButton ImageUrl="~/Images/reports-stack.png" ID="btnEdit" CommandArgument ='<%# DataBinder.Eval(Container, "DataItem.SOAppra_ID") %>' CommandName="View" runat="server"/>
                        </ItemTemplate>
                    ...
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                     ...
                     <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:ImageButton ImageUrl="~/Images/Delete.gif" ID="btnDelete" CommandArgument ='<%# DataBinder.Eval(Container, "DataItem.SOAppra_ID") %>' CommandName="DeleteRow" runat="server"/>
                        </ItemTemplate>
  ...
  <br />
           <asp:Panel ID="Panel1" runat="server" style=" width:56.8em; height:2.3em; margin-left:2em; background: url(../Images/1397d40aa687.jpg)">
                   <asp:button id="btnNewPass" text="Add New Staff Feedback" runat="server" style=" margin-left:280px; margin-top:.2em"
                 cssclass="Buttons" Width="249px" onclick="btnNewPass_Click"/>  
