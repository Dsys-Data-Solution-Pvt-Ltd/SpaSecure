<%@ Page Title="" Language="C#" MasterPageFile="~/master/SpaMaster.Master" AutoEventWireup="true"
    CodeBehind="PresentSite.aspx.cs" Inherits="SMS.ADMIN.PresentSite" %>
        ...
        <ul id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
            <li id="Present" runat="server">
                <asp:LinkButton ID="lnkPresent" runat="server" OnClick="lnkPresent_Click" CausesValidation="false">
                    <span id="spanPresent" runat="server" class="icon1">Present Site</span>
                </asp:LinkButton></li>
            <li id="Past" runat="server">
                <asp:LinkButton ID="lnkPast" runat="server" OnClick="lnkPast_Click" CausesValidation="false">
                    <span id="span_Past" runat="server" class="icon2">Past Site</span>
                </asp:LinkButton></li>
        </ul>
                    ...
                    <tr style="vertical-align: top;">
                        <td style="width: 80%">
                            ...
                            <telerik:RadGrid ID="gvLoctionTable" runat="server" CssClass="RadGrid" GridLines="None"
                                ...
                                EnableAJAX="true" AllowFilteringByColumn="true">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <contenttemplate>
                    <div class="divContainer">                  
                        ...
                        <br />
                        <asp:Panel ID="Panel1" runat="server" Style="margin-left: 1.5em; width: 58em; height: 200em;
                            margin-top: -2px">
