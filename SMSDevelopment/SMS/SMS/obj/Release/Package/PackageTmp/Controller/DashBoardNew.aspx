                                ...
                                <MasterTableView AlternatingItemStyle-ForeColor="#333333" AlternatingItemStyle-BackColor="#FFFFFF"
                                    ...
                                    <Columns>
                                                    ...
                                                    <MasterTableView AlternatingItemStyle-ForeColor="#333333" AlternatingItemStyle-BackColor="#FFFFFF"
                                                        ...
                                                        <Columns>
                                                            <telerik:GridTemplateColumn UniqueName="checkInUserInner">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="CheckINName" Text='<%# Eval("Name") %>' CommandArgument='<%# Eval("UserID") %>' CommandName="CheckIN" ToolTip='<%# Eval("UserID") %>' runat="server" Font-Bold="true"></asp:LinkButton>
                                                                    <%--<b><asp:Hyperlink ID="lblGuardCIStatus" runat="server" ToolTip='<%# Eval("Checkin_DateTime") %>'>Hello</asp:Hyperlink></b>--%>
                                                                </ItemTemplate>
                                                            </telerik:GridTemplateColumn>
                                                               <telerik:GridTemplateColumn UniqueName="checkInUserInner">
                                                                <ItemTemplate>
                                                                   <asp:Label ID="lblcheckout_time" runat="server" Text='<%# Eval("Checkin_DateTime") %>' ToolTip='<%# Eval("Checkin_DateTime") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </telerik:GridTemplateColumn>
                                                        </Columns>
                                                        <NoRecordsTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Recently Checkout" UniqueName="checkOutUser"
                                            HeaderStyle-CssClass="pageTitle">
                                            <ItemTemplate>
                                                <telerik:RadGrid ID="grdCurrCheckOuts" runat="server" AllowPaging="True" AutoGenerateColumns="false" OnItemCommand="grdCurrCheckOuts_ItemCommand">
                                                    <HeaderStyle CssClass="HeaderRow" HorizontalAlign="Center" />
                                                    <ItemStyle CssClass="NormalRow" />
                                                    <AlternatingItemStyle CssClass="AlternateRow" />
                                                    <PagerStyle CssClass="PagingRow" HorizontalAlign="Right" Height="21px" />
                                                    ...
                                                    <MasterTableView AlternatingItemStyle-ForeColor="#333333" AlternatingItemStyle-BackColor="#FFFFFF"
                                                        ...
                                                        <Columns>
                                                            <telerik:GridTemplateColumn UniqueName="checkOutUserInner">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="CheckOutName" Text='<%# Eval("UserName") %>' CommandArgument='<%# Eval("userid") %>' CommandName="CheckOut" ToolTip='<%# Eval("userid") %>' runat="server" Font-Bold="true"></asp:LinkButton>
                                                                    <%--<b><asp:Hyperlink ID="lblGuardCOStatus" runat="server" ToolTip='<%# Eval("checkout_time") %>'>Hello</asp:Hyperlink></b>--%>
                                                                </ItemTemplate>
                                                            </telerik:GridTemplateColumn>
                                                             <telerik:GridTemplateColumn UniqueName="checkInUserInner">
                                                                <ItemTemplate>
                                                                   <asp:Label ID="lblcheckout_time" runat="server" Text='<%# Eval("checkout_time") %>' ToolTip='<%# Eval("checkout_time") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </telerik:GridTemplateColumn>
                                                        </Columns>
                                                        <NoRecordsTemplate>
