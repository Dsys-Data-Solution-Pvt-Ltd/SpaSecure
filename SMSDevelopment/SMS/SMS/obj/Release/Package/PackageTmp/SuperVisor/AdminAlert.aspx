<%@ Page Language="C#" MasterPageFile="~/master/SpaMaster.Master" AutoEventWireup="true"
    CodeBehind="AdminAlert.aspx.cs" Inherits="SMS.SuperVisor.AdminAlert" Title="Admin Alert" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="divContainer">
        ...
        <asp:Panel ID="pnlAdd" runat="server" BackColor="White" Style="height: 550px; width: 750px; margin-top:-20px">
            <br />
                        ...
                        <asp:Panel ID="printview" runat="server" BackColor="White" Width="700px">
                            <table width="700px" class="table">
                                <tr>
                                    ...
                                    <td>
                                         <asp:TextBox ID="txtP_name" runat="server" CssClass="Input"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td colspan="4">
                                        <asp:Label ID="Label1" runat="server" Width="100px" ForeColor="#C5061B" CssClass="Labels" Font-Bold="True" Text="Alert Send For:"></asp:Label>
                                    </td>
                                </tr>
                                 <tr>
                                    <td>
                                    ...
                                    <td colspan="3">
                                    <telerik:RadComboBox ID="txtP_NricNo" runat="server" EnableAutomaticLoadOnDemand="true"
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:Label ID="lblalertedby" runat="server" Width="100px" ForeColor="#C5061B" CssClass="Labels" Font-Bold="True" Text="Alert Raised By:"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <telerik:RadComboBox ID="txtbynric" runat="server" Width="150" EnableAutomaticLoadOnDemand="true"
                                            EmptyMessage="Select NRIC No" AutoPostBack="true" Style="z-index: 1000000;" DataSourceID="SqlDataSource1"
                                            DataTextField="NRICno" DataValueField="NRICno" ItemsPerRequest="10" ShowMoreResultsBox="true"
                                            OnSelectedIndexChanged="txtbynric_TextChanged" EnableVirtualScrolling="true">
                                        </telerik:RadComboBox>
