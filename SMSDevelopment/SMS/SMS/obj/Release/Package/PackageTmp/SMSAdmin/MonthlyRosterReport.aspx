<%@ Page Language="C#" MasterPageFile="~/SMSmaster.Master" AutoEventWireup="true" CodeBehind="MonthlyRosterReport.aspx.cs" Inherits="SMS.SMSAdmin.MonthlyRosterReport" Title="" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="AJAX"%>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="divContainer">
        <div class="divHeader"><span class="pageTitle">Monthly Roster Report</span>
        </div>        
   ...
   <div>
        ...
        <asp:gridview id="gvItemTable" runat="server"
            ...
            <Columns>            
                            ...
                            <asp:BoundField DataField="ShiftTimeFrom" HeaderText="From Shift"></asp:BoundField>
                            <asp:BoundField DataField="ShiftTimeTo" HeaderText="To Shift"></asp:BoundField>                        
            </Columns>
    </asp:gridview>
    </asp:panel>
  </div>
