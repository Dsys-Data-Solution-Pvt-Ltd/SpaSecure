<%@ Page Language="C#" MasterPageFile="~/master/login.Master" AutoEventWireup="true" CodeBehind="ContractorView.aspx.cs" Inherits="SMS.SMSUsers.Reports.ContractorView" %>
...
<div class="divContainer">
        <div class="divHeader">
            <span class="pageTitle">Contractor Report</span></div>           
            ...
            <td align="center" colspan="4">
                ...
                <tr>
                    <td align="center" colspan="4" height="70px" valign="top">
                         <asp:Label ID="lblIncidentReport" Text="Contractor Report" CssClass="Labels" 
                  ...
                  <tr>                
                    <td>
                          <asp:Label ID="lblInTime" Text="In Time" CssClass="Reportcolor" 
               ...
               <tr>                              
                    ...
                    <td>
                         <asp:Label ID="lblAddress" Text="Address" CssClass="Reportcolor" 
                             runat="server" Font-Bold="True"></asp:Label>
                   </td> 
                    <td colspan="3">
                ...
                <tr>                              
                    ...
                    <td>
                         <asp:Label ID="lblPhone" Text="Contact No." CssClass="Reportcolor" 
                             runat="server" Font-Bold="True"></asp:Label>
                   </td> 
                    <td colspan="3">
                ...
                <tr>                              
                    ...
                    <td>
                         <asp:Label ID="lblPass" Text="Pass No." CssClass="Reportcolor" 
                             runat="server" Font-Bold="True"></asp:Label>
                   </td> 
                    <td>
               ...
               <tr>   
                   ...
                   <td>
                         <asp:Label ID="lblPassType" Text="Pass Type" CssClass="Reportcolor" 
                             runat="server" Font-Bold="True"></asp:Label>
                   </td> 
                    <td>
                ...
                <tr> 
                     ...
                     <td>
                         <asp:Label ID="lblKeyNo" Text="Key No." CssClass="Reportcolor" 
                             runat="server" Font-Bold="True"></asp:Label>
                   </td> 
                    <td>
               ...
               <tr>
                    <td>
                         <asp:Label ID="lblVehicle" Text="Vehicle No." CssClass="Reportcolor" 
                             runat="server" Font-Bold="True"></asp:Label>
                   </td> 
                    <td>
                ...
                <tr> 
                   ...
                   <td>
                         <asp:Label ID="lblCompanyFrom" Text="Company From" CssClass="Reportcolor" 
                             runat="server" Font-Bold="True"></asp:Label>
                   </td> 
                    <td colspan="3">
              ...
              <tr>
                    <td>
                         <asp:Label ID="lblToVisit" Text="To Visit" CssClass="Reportcolor" 
                             runat="server" Font-Bold="True"></asp:Label>
                   </td> 
                   <td colspan="3">
                ...
                <tr>   
                   ...
                   <td valign="top">
                         <asp:Label ID="lblRemark" Text="Remarks" CssClass="Reportcolor" 
                             runat="server" Font-Bold="True"></asp:Label>
                   </td> 
