<%@ Page Language="C#" MasterPageFile="~/master/Spamaster.Master" AutoEventWireup="true"
    CodeBehind="AttendanceReport.aspx.cs" Inherits="SMS.Reports.AttendenceReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlCheckinView" runat="server" BackColor="White" Style="height: 389px;
        width: 788px; margin-top: -15px">
        <br />
                    ...
                    <div style="background-color: #E4E4E4; width: 700px">
                        <center>
                            ...
                            <asp:Button ID="btnCheckinCancel" runat="server" Text="Cancel" CssClass="Button"
                                Font-Bold="True" Height="30px" Width="100px" OnClick="btnCheckinCancel_Click" />
                        </center>
                    </div>
                </center>
            </ContentTemplate>
    ...
    <asp:Panel ID="pnlCheckOutView" runat="server" BackColor="White" Style="height: 371px;
        width: 788px; margin-top: -15px">
        <br />
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
            <ContentTemplate>
                <center>
                    ...
                    <div style="background-color: #E4E4E4; width: 700px">
                        <center>
                            <a id="A1" href="printpage.aspx" class="Button" runat="server" target="_blank" style="height: 30px;
                                width: 100px; color: White; padding: 7px 30px 7px 30px">Print</a>
                            <asp:Button ID="btnCheckOutCancel" runat="server" Text="Cancel" CssClass="Button"
                                Font-Bold="True" Height="30px" Width="100px" OnClick="btnCheckOutCancel_Click" />
                        </center>
                    </div>
                </center>
            </ContentTemplate>
