<%@ Page Language="C#" MasterPageFile="~/master/SpaMaster.Master" AutoEventWireup="true"
    CodeBehind="IncidentReport.aspx.cs" Inherits="SMS.Reports.IncidentReport" %>
...
<telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
    ...
    <div class="divHeader">
        <span class="pageTitle">Incident Report</span>
    </div>
        <div class="btnbar">
            <div class="btnbarBox">
                <ul>
                            ...
                            <ContentTemplate>--%>
                              <asp:Panel ID="panelgrid" runat="server">
                                <telerik:RadGrid ID="gvItemTable" runat="server" CssClass="RadGrid" GridLines="None"
                                    ...
                                    <MasterTableView CommandItemDisplay="Bottom" DataKeyNames="Incident_id">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn UniqueName="Date_of_Incident" HeaderText="Date of Incident"
                                                DataField="Date_of_Incident" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true"
                                                ShowFilterIcon="false">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="Time_of_Incident" HeaderText="Time of Incident"
                                                DataField="Time_of_Incident" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true"
                                                ShowFilterIcon="false">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="Report_No" HeaderText="Report No" DataField="Report_No"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="Reported_By" HeaderText="Reported By" DataField="Reported_By"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="Verified_By" HeaderText="Verified By" DataField="Verified_By"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="follownric" HeaderText="Followed By" DataField="follownric"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                                            </telerik:GridBoundColumn>
                                        </Columns>
                                    </MasterTableView>
      ...
      <center>
        <table style=" background-color: #E4E4E4; width:50%;" >
                <tr>
                    <td>
                        <asp:Label ID="exportto" runat="server" CssClass="Labels" Font-Bold="true" Text="Export To:"></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="Labels" Width="81px">
                            <asp:ListItem>Pdf</asp:ListItem>
                            <asp:ListItem>Word</asp:ListItem>
                        </asp:DropDownList>
                        <asp:Button ID="btnGo" runat="server" CssClass="Button" OnClick="btnGo_Click" Text="Go"
                            Style="margin-left: 20px" Height="25px" Width="68px" />
                    </td>
                </tr>
            </table>
            </center>
        ...
        <asp:ModalPopupExtender ID="ModalPopupIncidentView" runat="server" CancelControlID="btnIncidentCancel"
            TargetControlID="hdnAdd" BackgroundCssClass="modalBackground" PopupControlID="pnlIncidentView">
        </asp:ModalPopupExtender>
        <asp:Panel ID="pnlIncidentView" runat="server" BackColor="White" Style="height: 480px;
            width: 750px;">
            <br />
                ...
                <center>
                    <asp:Panel ID="printview" runat="server" BackColor="White" width="700px">
                        <table width="700px">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblreportedby" Text="Reported Filed By :" CssClass="Reportcolor" runat="server"
                                        Font-Bold="True"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td valign="top">
                                    <asp:Label ID="lblstatement" Text="Statement :" CssClass="Reportcolor" runat="server"
                                        Font-Bold="True"></asp:Label>
                                </td>
                            ...
                            <tr>
                                <td colspan="4" height="20px">
                                    <asp:Label ID="lblfollowupstatus" Text="Incident Follow Up Status" CssClass="Labels"
                                        runat="server" Font-Bold="True" Font-Size="15px" ForeColor="Black"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="lblfollowverify" Text="Verified By :" CssClass="Reportcolor" runat="server"
                                        Font-Bold="True"></asp:Label>
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:Label ID="lblfollownric" Text="NRIC/FIN No. :" CssClass="Reportcolor" runat="server"
                                        Font-Bold="True"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblfollowinvestigate" Text="Investigated By :" CssClass="Reportcolor"
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblfollowstatus" Text="Status :" CssClass="Reportcolor" runat="server"
                                        Font-Bold="True" Visible="False"></asp:Label>
                                </td>
                                <td colspan="3">
                                    <asp:Label ID="txtfollowstatus" CssClass="Reportcolor" runat="server" Visible="False"></asp:Label>
                                </td>
                            </tr>
                      ...
                      <br />
                      <br />
                        <table style="background-color: #E4E4E4; width:700px">
                        <tr>
                        <td > 
                        <center>
                     
                          <a id="print" href="printpage.aspx" class="Button" runat="server" target="_blank" style=" color:White; padding:7px 30px 7px 30px" >Print</a>

                                    <asp:Button ID="btnIncidentCancel" runat="server" Text="Cancel" CssClass="Button"
                                        Font-Bold="True" Height="30px" Width="100px" OnClick="btnIncidentCancel_Click" />
                                        </center>
