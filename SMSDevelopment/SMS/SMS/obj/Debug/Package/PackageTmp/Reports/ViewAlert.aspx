<%@ Page Language="C#" MasterPageFile="~/SMSmaster.Master" AutoEventWireup="true" CodeBehind="ViewAlert.aspx.cs" Inherits="SMS.SMSUsers.Reports.ViewAlert" %>
...
<div class="divContainer" style="background-color: #FFFFFF">
      ...
      <div align="center">
          ...
          <asp:Button ID="btnprint" runat="server" Text="Print" CssClass="Buttons" 
              Font-Bold="True" Height="35px" Width="100px"/>
