...
//  var hdnFullFilePath = parent.document.getElementById('<%= hdnFullFileName.ClientID%>');    
  var hdnFinalFileName = parent.document.getElementById("hdnFinalFileName").value;       
   DEFAULT_URL = hdnFinalFileName;   
...
//#if !B2G
  ...
  var ctrSearchTerm = parent.document.getElementById("ctl00_middleContentPlaceHolder_hdnSearchTerm");
  var ctrSearchTerm1 = parent.document.getElementById("middleContentPlaceHolder_hdnSearchTerm");

if(ctrSearchTerm1 !=null)
{
    ctrSearchTerm =ctrSearchTerm1;
}
  if(ctrSearchTerm != null && ctrSearchTerm.value != null && ctrSearchTerm.value != "" && ctrSearchTerm.value != undefined)
  {
    PDFFindBar.findField.value = ctrSearchTerm.value;
