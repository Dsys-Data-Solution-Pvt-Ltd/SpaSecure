<%@ Page Language="C#" MasterPageFile="~/master/SpaMaster.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="PresentStaff.aspx.cs" Inherits="SMS.ADMIN.PresentStaff"
    Title="Present Page" %>
...
'       msgbox(VerificationFeatureSet)
'            document.getElementById("ctl00_ContentPlaceHolder1_TabContainer1_tabpanel5_hdnFP2").value = OctetToHexStr(VerificationFeatureSet.Serialize)
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="divContainer">
                            ...
                            <telerik:RadGrid ID="gvLoctionTable" runat="server" CssClass="RadGrid" GridLines="None"
                                ...
                                <MasterTableView CommandItemDisplay="Bottom" DataKeyNames="Staff_ID">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn UniqueName="Staff_Telphone" HeaderText="Telephone" DataField="Staff_Telphone"
                                            AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn UniqueName="Role" AutoPostBackOnFilter="true" HeaderText="Role"
                                            DataField="Role" CurrentFilterFunction="Contains" ShowFilterIcon="false">
                                        </telerik:GridBoundColumn>
        ...
        <asp:Panel ID="PnlOk" runat="server" BackColor="White" Height="260px" Width="320px"
