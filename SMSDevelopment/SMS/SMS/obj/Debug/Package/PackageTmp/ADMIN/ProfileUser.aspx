<%@ Page Title="" Language="C#" MasterPageFile="~/master/login.Master" AutoEventWireup="true"
    CodeBehind="ProfileUser.aspx.cs" Inherits="SMS.ADMIN.ProfileUser" %>
    ...
    <div class="divContainer">
        ...
        <div id="divAdvSearch" runat="server" visible="true">
            <asp:Panel ID="printview" runat="server">
                <table width="750px" cellspacing="10px" style="margin-left: 1.5em; background-color: White">
                    <tr>
            ...
            <br />
            <div>
                <table style="margin-left: 1.5em; background-color: White; width: 750px; height: 14em">
                    <tr>
                        <td>
            ...
            <div align="center" style=" margin-left:1.5em">
            <table width="750px" style="margin-left:0.001em; margin-bottom: -0.4em; border: 1px;
                ...
                <asp:Button ID="btnprint" runat="server" CssClass="Buttons" Text="Print" Width="110px"
                    Height="35px" OnClick="btnprint_Click" Font-Bold="True" />
                     </td>
                    </tr>
                </table>
            </div>
